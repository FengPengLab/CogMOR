...
set val(suc)    1                          ;# set the number of SUC nodes
set val(out)    SHCS3
#===================================
#        Initialization        
#===================================
...
set god [create-god [expr $val(su) + $val(pu) + $val(suc)]]
