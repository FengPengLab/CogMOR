...
(3) Create wireless channel

```
$ns add-channel [expr $val(nc)] $val(chan)
```

(4) Mobile node parameter setup
...
# -nodeWorkMode   0  ——  This is how the nodes work, 0 is the SU node, 2 is the PU node
# -noiseChannel   0  ——  This is the PU active channel
# -noiseStartTime 0  ——  This is when the PU starts to move
```

(5) SU nodes definition
...
(7) Agents definition & applications definition
